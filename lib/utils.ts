...
export const NIGERIAN_STATES = [
  ...
  'Pickup', 'Lagos Island, Surulere & Yaba', 'Magodo, Ketu & Berger',
  'Lekki Phase 1, VI & Ikoyi', 'Ajah, VGC & Badore', 'Gbagada, Ikeja & Ogba',
  'Egbeda, Ipaja & Ikotun', 'Ikorodu & Sango',
...
export const DELIVERY_ZONES = [
  {
    id: 'pickup',
    name: 'Pickup',
    carrier: 'Self collection',
    note: 'Collect your order in person — no delivery fee.',
    states: ['Pickup'],
    color: '#22c55e',
    defaultFee: 0,
    defaultHeavyFee: 0,
  },
  {
    ...
    name: 'Lagos Island, Surulere & Yaba',
    carrier: 'Local delivery',
    note: 'Lagos Island, Surulere, Yaba',
  ...
  },
  {
    ...
    name: 'Magodo, Ketu & Berger',
    carrier: 'Local delivery',
    note: 'Magodo, Ketu, Berger',
  ...
  {
    id: 'lekki-vi-ikoyi',
    name: 'Lekki Phase 1, VI & Ikoyi',
    carrier: 'Local delivery',
    note: 'Lekki Phase 1, Ikate, Victoria Island, Ikoyi, Jakande, Sangotedo, Awoyaya, Lakowe',
  ...
  {
    id: 'ajah-vgc-badore',
    name: 'Ajah, VGC & Badore',
    carrier: 'Local delivery',
    note: 'Badore, Abraham Adesanya, Ikota, Chevron, Adesanya, Ogombo, VGC, Ajah',
  ...
  },
  {
    ...
    name: 'Gbagada, Ikeja & Ogba',
    carrier: 'Local delivery',
    note: 'Gbagada, Ilupeju, Ikeja, Ogba and environs',
  ...
  },
  {
    ...
    name: 'Egbeda, Ipaja & Ikotun',
    carrier: 'Local delivery',
    note: 'Egbeda, Igando, Iyana Ipaja, Ikotun, Ipaja, Abule Egba',
